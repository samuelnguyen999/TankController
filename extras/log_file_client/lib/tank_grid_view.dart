...
class TankGridView extends State<MyHomePage> {
  ...
  Future<dynamic> getData() async {
    var url = Uri.https('https://oap.cs.wallawalla.edu/logs/');
      ...
      MaterialPageRoute<void>(
        builder: (context) {
          return Scaffold(
              ...
              body: myFutureBuilder(context, index));
        },
      ),
    );
  }

  FutureBuilder<dynamic> myFutureBuilder(BuildContext context, int index) {
  ...
  Table myTable(BuildContext context, int index) {
    return Table(
      border:
